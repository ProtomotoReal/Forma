                    ...
                    <div class="form-group">
                        <div class="col-sm-10">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="row">
                                        <div class="col-sm-10"><?php echo $entry_option; ?></div>
                                        <div class="col-sm-1"><input type="checkbox" name="filter_option" value="1" class="form-control"/></div>
                                    </div>
                                </div>
                            </div>
                        </div>
