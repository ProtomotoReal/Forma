...
class ControllerExtensionModuleSoMegaMenu extends Controller {
    ...
    public function index() {
        ...
        elseif (isset($_GET['duplicate']))
        {
            ...
            $this->response->redirect(HTTPS_SERVER . 'index.php?route=extension/module/so_megamenu&token=' . $this->session->data['token'].'&module_id='.$this->request->get['module_id'].'&edit='. $new_menu_id);
        }
