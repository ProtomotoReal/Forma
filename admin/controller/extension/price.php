...
class ControllerExtensionPrice extends Controller {
    ...
    public function error() {
        if (function_exists("file_get_contents")) {
            $this->response->redirect($this->url->link($this->type . '/' . $this->name, 'token=' . $this->session->data['token'], true));
        }
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href'      => $this->url->link($this->type . '/' . $this->name, 'token=' . $this->session->data['token'], true),
            
        );

        $data['action'] = $this->url->link($this->type . '/' . $this->name, 'token=' . $this->session->data['token'], true);
        $data['cancel'] = $this->url->link('extension/' . $this->type, 'token=' . $this->session->data['token'], true);
        ...
        $this->response->setOutput($this->load->view($this->type . '/' . $this->name . '_error.tpl', $data));
    }
    ...
    public function index() {
        if (!function_exists("file_get_contents")) {
            $this->response->redirect($this->url->link($this->type . '/' . $this->name . '/error', 'token=' . $this->session->data['token'], true));
        }

        if (!class_exists('Louise170') or !method_exists($this->louise170, 'check_license_adminka_276000') ) {
            $this->response->redirect($this->url->link($this->type . '/' . $this->name . '/error2', 'token=' . $this->session->data['token'], true));
        }
        ...
        foreach ($this->methods as $method) {
            ...
            $data['methods'][$method]['action'] = $this->url->link($this->type . '/' . $this->name.'/'.$method, 'token=' . $this->session->data['token'], true);
        }

        $data['clear'] = $this->url->link('extension/price/clear', 'token=' . $this->session->data['token'], true);
    ...
    public function price() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href'      => $this->url->link($this->type . '/' . $this->name . '/' . $this->local_name, 'token=' . $this->session->data['token'], true),
            'separator' => ' :: '
        );


        $data['action'] = $this->url->link($this->type . '/' . $this->name . '/' . $this->local_name, 'token=' . $this->session->data['token'], true);
        $data['cancel'] = $this->url->link($this->type . '/' . $this->name, 'token=' . $this->session->data['token'], true);
        ...
        $this->response->setOutput($this->load->view($this->type . '/' . $this->name . '_' . $this->local_name . '.tpl', $data));
    ...
    public function category() {
        ...
        return $this->load->view($this->type . '/' . $this->name . '_common_category.tpl', $data);
    }
    ...
    public function rnd() {
        ...
        return $this->load->view($this->type . '/' . $this->name . '_common_rnd.tpl', $data);
    }
