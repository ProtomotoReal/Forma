...
<div class="layout-3">
    ...
    <div class="container">
		...
		<div class="current-name">
			<?php echo array_pop($breadcrumbs)['text']; ?>
		</div>
                    ...
                    <?php if(isset($article_info_found)) { ?>
                        <div class="article-info">
                            ...
                            <div class="article-sub-title">
								<?php /*
                                <span class="article-author"><a href="<?php echo $author_url; ?>"><?php echo $text_posted_by; ?>: <?php echo $article_info['author_name']; ?></a></span>

								*/?>
                           
                                <span class="article-date"><?php echo $text_created; ?>: <?php echo  $article_date_modified;?></span>
                            ...
                            <!-- DESCRIP -->
                            <?php if(isset($featured_found)) { ?>
    							<div class="article-description" style="">
    								<?php echo html_entity_decode($article_info['description'], ENT_QUOTES, 'UTF-8'); ?>
    							</div>
    						<?php } else { ?>
