...
$short_by = !empty ($pagination) ? 'col-md-4 col-sm-4 col-xs-12' : 'col-md-10 col-sm-12';
...
<div class="breadcrumbs" data-crumb="<?php echo $root_category['category_id']; ?>">
	<div class="container">
...
<div class="container product-listing content-main">
    ...
    <?php $class = 'col-md-6 col-sm-12 col-xs-12'; ?>
