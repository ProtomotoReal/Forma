...
<?php // Header Blocks =========================================?>
<?php echo $header; ?>
<script src="/catalog/view/javascript/select2buttons/jQuery.select2Buttons.js"></script>
<link rel="stylesheet" href="/catalog/view/javascript/select2buttons/select2Buttons.css">
<script>
	$(document).ready(function(){
		$('select[data-optionid="11"]').select2Buttons();
	});
</script>
                        ...
                        <div id="thumb-slider" class="thumb-vertical-outer">
							...
							<ul class="thumb-vertical">
								...
								if ($images) : ?>
									...
									<li class="owl2-item "
									<?php
										if (isset($image['options_selected'])){
											foreach ($image['options_selected'] as $opt){
												echo 'data-image-option-' . $opt . '="' . $opt . '"';
											}
										}
				...
				<div id="product">
					...
					<?php foreach ($options as $option) { ?>
						...
						<div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
							...
							<select name="option[<?php echo $option['product_option_id']; ?>]" id="input-option<?php echo $option['product_option_id']; ?>" class="form-control" data-optionid="<?php echo $option['option_id']; ?>">
											...
											<span class="option-content-box" data-title="<?php echo $radio_price;?>" data-toggle='tooltip'>
												...
												<?php
													...
													foreach ($images as $image) {
														if (isset($image['options_selected'])){
															foreach ($image['options_selected'] as $opt){
																if ($opt == $option_value['product_option_value_id'] ){
																	$option_product_image = $image['thumb'];
																}
															}
														}
													}
												...
												<?php if ($option_value['image'] || $option_product_image) { ?>

												<img src="<?php echo ($option_product_image ?
													$option_product_image :
													$option_value['image']); ?>" alt="<?php echo $option_value['name'] . ($option_value['price'] ? ' ' . $option_value['price_prefix'] . $option_value['price'] : ''); ?>" class="img-thumbnail" />
												<?php } else { ?>
												<img src="" alt="" class="img-thumbnail fake" >
												<?php } ?>
					...
					<div class="cart clearfix">
						...
						<br/>
						<a href="#" onclick="openbox('.openbox_sizes'); return false" class="define_size">Определите свой размер</a>
...
<div id="popup">
<div id="openbox_sizes" class="openbox_sizes">

	<div class="title">Таблица размеров</div>
	<div class="close" onclick="openbox('.popup_callback'); return false;"></div>
	<div>
		<table align="center" width="100%">
			<tbody>
			<tr class="tr_head">
				<td width="30%"><div>Возраст</div></td>
				<td width="40%"><div>Размер</div></td>
				<td width="30%"><div>Рост</div></td>
			</tr>
			<tr class="data-size">
				<td>
					0/3 мес.
			...
			<tr class="tr_head">
			<td width="20%"><div>Российский размер</div></td>
			<td width="20%"><div>Обхват бедер, в см</div></td>
			<td width="20%"><div>Обхват груди, в см</div></td>
			<td width="20%"><div>Обхват талии, в см</div></td>
			<td width="20%"><div>Размер производителя</div></td>
			</tr>
			<tr class="data-size">
				<td>50</td>
				<td>106-110</td>
