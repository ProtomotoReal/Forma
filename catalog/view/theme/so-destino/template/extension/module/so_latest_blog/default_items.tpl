<div class="item">
	...
	<div class="media-left">
		...
		<?php if($display_date_added){ ?>
			<div class="media-date-added"><b><?php echo date('j', strtotime($blog['date_modified'])) ?></b><span><?php

			$monthes = array('', 'Янв','Фев','Мар','Апр','Мая','Июн','Июл','Авг','Сен','Окт','Нбр','Дек');

			$m = date('m', strtotime($blog['date_modified']));

			echo $monthes[(int)$m] ?></span>
			</div>
		<?php }?>
	</div>
