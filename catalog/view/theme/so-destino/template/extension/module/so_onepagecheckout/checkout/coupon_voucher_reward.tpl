                ...
                <div class="panel-body">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <input type="button" value="Применить" id="button-coupon" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary">
                        </span>
                    </div>                    
                </div>
              </div>
...
<?php }else {?>
    <div class="checkout-content coupon-voucher">
        <h2 class="secondary-title"><i class="fa fa-gift"></i><?php echo $text_coupon_voucher?></h2>
        <div class="box-inner">
            <?php if ($coupon_status): ?>
            <div class="panel-body checkout-coupon">
                ...
                <div class="input-group">
                    <input type="text" name="coupon" value="<?php echo $coupon; ?>" placeholder="<?php echo $text_enter_coupon_code?>" id="input-coupon" class="form-control" />
                    <span class="input-group-btn">
                        <input type="button" value="Применить" id="button-coupon" data-loading-text="<?php echo $text_loading; ?>"  class="btn-primary button" />
                    </span>
                </div>
            </div>
            <?php endif; ?>
