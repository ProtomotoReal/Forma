<div class="responsive megamenu-style-dev <?php echo $ustawienia['suffix_class'];?>">
	...
	<div class=" container-megamenu  <?php if($ustawienia['orientation'] == 1) { echo 'vertical '; } else { echo 'horizontal'; } ?>">
		...
		<?php } else { ?>
		<div class="navbar-header">
			<span class="visible-xs-block visible-sm-block visible-md-block pull-right" style="line-height: 40px; padding-left: 15px;"><?php echo $navigation_text; ?></span>
														...
														foreach($submenu['subcategory']['categories'] as $categories){
															echo'<li>';
																...
																if($submenu['subcategory']['show_image'] == 1)
																	echo '<a href="'.$categories['href'].'"><img src="'.$categories['thumb'].'" alt="" ></a>';
															echo '</li>';		
														}
													echo '</ul>';
												}
										...
										echo '<div class="col-sm-'.$submenu['content_width'].'">';
												...
												elseif($submenu['content_type'] == '5') {
													if(isset($submenu['subcategory']['categories'])){
														echo '<ul class="subcategory '.$submenu['class_menu'].' columns-'.$submenu['subcategory']['columns'].'">';
															foreach($submenu['subcategory']['categories'] as $categories){
																echo'<li>';
																	if($submenu['subcategory']['show_title'] == 1)
																		echo'<a href="'.$categories['href'].'" class="title-submenu '.$submenu['class_menu'].'">'.$categories['name'].'</a>';
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		if(itemver <= $( ".vertical ul.megamenu >li" ).length)
			$('.vertical ul.megamenu').append('<li class="loadmore"><i class="fa fa-plus-square-o"></i><span class="more-view"> <?php echo $text_more_category ?></span></li>');
		...
		$(".megamenu .loadmore").click(function(){
			if($(this).hasClass('open')){
				...
				$('.loadmore').html('<i class="fa fa-plus-square-o"></i><span class="more-view"><?php echo $text_more_category ?></span>');
			}else{
				$('ul.megamenu li.item-vertical').each(function(i){
						if(i>show_itemver){
								$(this).slideDown(200);
				...
				$(this).addClass('open');
				$('.loadmore').html('<i class="fa fa-minus-square-o"></i><span class="more-view"><?php echo $text_close_category ?></span>');
			}
		});
	});
</script>
