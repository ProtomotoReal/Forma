...
<input type="radio" name="type" value="1" id="show">Физ.Лицо
<input type="radio" name="type" value="2" id="show2">Юр.Лицо<br>
<!--Физические лица-->
...
<div ID="layer2" style="display:none;">
 <fieldset>
 <legend>Информация для юр.лиц</legend>
           <div class="form-group">
            <label class="col-sm-2 control-label" for="input-company">Наименование компании</label>
            <div class="col-sm-10">
              <input type="text" name="company" placeholder="Наименование компании" id="input-company" class="form-control" />
            </div>
          </div>
		   <div class="form-group">
            <label class="col-sm-2 control-label" for="input-company">ИНН</label>
            <div class="col-sm-10">
              <input type="text" name="inn" placeholder="ИНН" id="input-inn" class="form-control" />
            </div>
          </div>
		    <div class="form-group">
            <label class="col-sm-2 control-label" for="input-company">ОГРН</label>
            <div class="col-sm-10">
              <input type="text" name="ogrn" placeholder="ОГРН" id="input-ogrn" class="form-control" />
            </div>
          </div>
		    <div class="form-group">
            <label class="col-sm-2 control-label" for="input-company">Тип юр.лица</label>
            <div class="col-sm-10">
              <input type="text" name="type_ur" placeholder="Тип юр.лица" id="input-type_ur" class="form-control" />
            </div>
          </div>
 </fieldset>
</div>
