...
<div id="sosearchpro" class="sosearchpro-wrapper so-search search-pro <?php echo $additional_class; ?>">
	...
	<div class="searchbox">
		...
		<div id="search<?php echo $module ?>" class="search input-group">
			...
			<?php } ?>
		    <input class="autosearch-input form-control" type="text" value="" size="50" autocomplete="off" placeholder="Поиск товара по каталогу" name="search">
		    <!--<span class="input-group-btn">
				<button type="submit" class="button-search btn btn-default btn-lg" name="submit_search"><?php //echo $text_btn_search; ?><i class="fa fa-search"></i></button>
