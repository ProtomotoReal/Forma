...
<div class="breadcrumbs">
	<div class="container ">
			...
			<div class="slider-wrapper">
				<div class="pager">
					<a href="#" data-slide-index="0"><img src="img/girls/1.jpg" alt=""></a>
					<a href="#" data-slide-index="1"><img src="img/girls/2.jpg" alt=""></a>
					<a href="#" data-slide-index="2"><img src="img/girls/3.jpg" alt=""></a>
				</div>
				<div class="good-slider">
					<div class="good-slide"><img src="img/girls/1.jpg" alt=""></div>
					<div class="good-slide"><img src="img/girls/2.jpg" alt=""></div>
					<div class="good-slide"><img src="img/girls/3.jpg" alt=""></div>
				</div>
			</div>
			<div class="good-descr">
				<h1>Блуза для девочки</h1>
				<div class="rating">
					<i class="fa-star"></i>
					<i class="fa-star"></i>
					<i class="fa-star"></i>
				...
				<div class="price">
					...
					<span>Арт. 01-0001</span>
				</div>
				<form action="#">
					<div class="radio color"><input id="color1" type="radio" name="color" value="white"><label for="color1"><img src="img/girls/9.jpg" alt=""></label></div>
					<div class="radio color"><input id="color2" type="radio" name="color" value="gray"><label for="color2"><img src="img/girls/10.jpg" alt=""></label></div>
					<div class="size">
						<a href="#">Определите свой размер</a>
						<div class="radio"><input id="size1" type="radio" name="size" value="128-134"><label for="size1">128-134</label></div>
						<div class="radio"><input id="size2" type="radio" name="size" value="134-140"><label for="size2">134-140</label></div>
						<div class="radio"><input id="size3" type="radio" name="size" value="140-146"><label for="size3">140-146</label></div>
						<div class="radio"><input id="size4" type="radio" name="size" value="146-152"><label for="size4">146-152</label></div>
						<div class="radio"><input id="size5" type="radio" name="size" value="152-158"><label for="size5">152-158</label></div>
						<div class="radio"><input id="size6" type="radio" name="size" value="158-164"><label for="size6">158-164</label></div>
					</div>
					<p><b>Цвет: </b>серый, белый</p>
					<p><b>Состав: </b>полиэстр 62%, вискоза 35%, эластан 3%</p>
					<p><b>Описание: </b>Невероятно удобное классическое платье на натуральной подкладке. Выполнено из дышащей, приятной на ощупь костюмной ткани, с включением тиаровой нити , благодаря которой обладает износостойкостью...</p>
					<div class="submit">
						<button type="submit">В корзину</button>
						<div class="number">
							<span onclick="plus()">+</span>
							<input id="number" type="text" name="amount" value="1" readonly>
							<span onclick="minus()">-</span>
						</div>
					</div>
				</form>
				<a href="#" class="good-tool"><i class="fa-bar-chart"></i> Добавить в сравнение</a>
				<a href="#" class="good-tool"><i class="fa-heart"></i> Отложить на потом</a>
			</div>
			<div class="delivery">
				<h6>Условия доставки</h6>
				<div class="h7">Ваш населенный пункт</div>
				<strong>Краснодар</strong>
				<div class="h7">Способ доставки</div>
				<strong>Самовывоз курьером постамат</strong>
				<div class="date">Ближайшая дата доставки:<br/><span>14.07.2017</span></div>
				<h6>Пункты самовывоза</h6>
...
<div class="content-main container product-detail <?php echo'product-'. $getColumn;?>">
	<div class="row">
    ...
    <div id="content" class="<?php echo $class; ?>">
    	<?php if ($column_left || $column_right) { ?>
    	<a href="javascript:void(0)" class="open-sidebar hidden-lg hidden-md"><i class="fa fa-bars"></i><?php echo $objlang->get('text_sidebar'); ?></a>
        ...
        <div class="row product-view product-info product-view-bg clearfix" itemprop="offerDetails" itemscope itemtype="http://schema.org/Product">
			...
			?>
				<div class="content-product-left  <?php if(isset($thumbnails_position) && $thumbnails_position == 'bottom') echo "class-honizol"; ?> <?php echo $left_gallery; ?> ">
                    ...
                    <?php if ($images  && isset($thumbnails_position) && $thumbnails_position == 'bottom') : ?>
                        <div id="thumb-slider" class="<?php echo ((count($images) < 4 ) ? 'not_full_slider' : 'full_slider'); ?> <?php echo ($thumbnails_position == 'left' ? 'flexslider-large visible-xs' : 'owl-carousel'); ?>">
							<?php
							if (sizeof($images) > 0) {
								$firstimg = array('popup' => $popup,'thumb' => $thumb);
								array_unshift($images, $firstimg);
			...
			<div class="content-product-right <?php if(isset($thumbnails_position) && $thumbnails_position == 'bottom') echo "info-right"; ?> <?php  echo $right_gallery; ?>">
				...
				<div class="title-share"><?php echo $objlang->get('text_sharethis'); ?></div>
				<div class="wrap-content">
				<a href="http://www.facebook.com/share.php?u=<?php echo $crumbInfo['href']; ?>&title=<?php echo $crumbInfo['text']; ?>" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;"><i class="fa fa-facebook"></i></a>
				<a href="http://twitter.com/home?status=<?php echo $crumbInfo['href']; ?>+<?php $crumbInfo['href']; ?>" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;"><i class="fa fa-twitter"></i></a>
				<a href="https://plus.google.com/share?url=<?php echo $crumbInfo['href']; ?>" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;"><i class="fa fa-google-plus"></i></a>
				<a href="https://dribbble.com/<?php echo $crumbInfo['href']; ?>" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;"><i class="fa fa-dribbble"></i></a>
				<a href="https://www.instagram.com/?hl=en=<?php echo $crumbInfo['href']; ?>" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;"><i class="fa fa-instagram"></i></a>
				</div>
				</div>
		...
		<div class="row product-bottom">
			...
			<div class="<?php echo $related_column;?>">
				...
				<div class="producttab ">
					<div class="tabsslider  <?php if ($tabs_position == 1){ echo "vertical-tabs"; } else echo "horizontal-tabs";?> col-xs-12">
							...
							<div class="panel-body">
								<form>
									...
									<div class="contacts-form">
										...
										<a id="button-review" class="btn btn-mega"><?php echo $button_continue; ?></a>
