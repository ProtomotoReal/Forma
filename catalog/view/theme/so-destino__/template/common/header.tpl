...
<?php // Begin General CSS ----- 
	...
	$this->soconfig->addCss('catalog/view/css/slider/jquery.bxslider.min.css');
	$this->soconfig->addCss('catalog/view/css/css/style.css');
	$this->soconfig->addCss('catalog/view/css/css/iconmoon.css');
	//$this->soconfig->addCss('catalog/view/css/css/media.css');
	$this->soconfig->addCss('catalog/view/css/css/font-awesome.css');
?>
...
<div id="wrapper" class="<?php echo $cls_wrapper; ?>">   
	...
	if(isset($typeheader)){
		...
		case "2":
			...
			break;
		case "3":
			$header3 = DIR_TEMPLATE.$theme.'/template/header/header_main.tpl';
