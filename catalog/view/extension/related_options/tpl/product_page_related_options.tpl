...
function ro_getSpecificFunctions(ro_instance) {
	...
	var ro_functions = {
		...
		event_setOptionValue_after : function(event, product_option_id, product_option_value_id, $touched_elems) { // ro_event_setOptionValue_after
			if ( $touched_elems && $touched_elems.length && $touched_elems.is(':radio') ) {
				<?php if ($ro_theme_name=='sstore' || $ro_theme_name=='storeset' ) { ?>
					ro_instance.sstore_setOptionsStyles(radio_elems.first());
					//ro_sstore_setOptionsStyles(radio_elems.first());
		...
		event_setAccessibleOptionValues_select_after : function (event, product_option_id) {
			<?php if ( $ro_theme_name == 'theme625' || $ro_theme_name == 'theme628' || $ro_theme_name == 'theme630' || $ro_theme_name == 'theme638' || $ro_theme_name == 'theme649' || $ro_theme_name == 'theme707' || $ro_theme_name == 'themeXXX' ) { ?>
